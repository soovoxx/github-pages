...
tags: ["camelCase", "snake_case", "spring-jpa"]
---
...
### **이유 1) JPA 기본 네이밍 전략과 가장 잘 맞음**

Hibernate는 기본적으로 isActive → is_active 로 자동 변환하도록 설정되어 있어.

그래서 snake_case로 해두면 엔티티에 @Column 안 적어도 자동 매핑이 아주 자연스럽게 돼.

### **이유 2) SQL에서는 snake_case가 더 읽기 쉬움**
...
### **이유 3) 팀 협업 시 DB 표준은 대부분 snake_case**
...
### **이유 4) camelCase 컬럼을 쓰면 이런 문제가 생김**
